...
$result = mysqli_query($con,"SELECT * FROM order_characteristic");

echo"<h1><center><font color=#00FFFF>Order Characteristics!</font></center></h1>";
...
while($row = mysqli_fetch_array($result)) {
  ...
  echo "<td>" . $row['ODR_CHR_DESCRIPTION'] . "</td>";
  echo "</tr>";
}
